...
- **Orbital map:** single-click a drive node to select it, right-click it for **Explore in Drive Station** or **Open in Finder**, and double-click to open it. Choose the double-click action in Station Settings.
